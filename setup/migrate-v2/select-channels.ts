 ...
 *
 * If NANOMIKA_CHANNELS env var is set (comma-separated names), skips the
...
async function main(): Promise<void> {
  ...
  // Non-interactive: NANOMIKA_CHANNELS="telegram,discord"
  const envChannels = process.env.NANOMIKA_CHANNELS?.trim();
  if (envChannels) {
