...
```yaml
- uses: nanocoai/nanomika/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [NanoMika](https://github.com/nanocoai/NanoMika) | ![tokens](https://raw.githubusercontent.com/nanocoai/NanoMika/main/repo-tokens/badge.svg) |
