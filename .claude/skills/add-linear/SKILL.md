...
2. Create an app (e.g. "NanoMika Bot")
   - Developer URL: your repo URL (e.g. `https://github.com/your-org/nanomika`)
...
NanoMika doesn't ship channels in trunk. This skill copies the Linear adapter in from the `channels` branch and patches the Chat SDK bridge to support catch-all message forwarding (Linear OAuth apps can't be @-mentioned).
...
LINEAR_BOT_USERNAME=NanoMika Bot
LINEAR_TEAM_KEY=ENG
```
