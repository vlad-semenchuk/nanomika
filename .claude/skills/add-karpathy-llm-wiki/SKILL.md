...
description: Add a persistent wiki knowledge base to a NanoMika group. Based on Karpathy's LLM Wiki pattern. Triggers on "add wiki", "wiki", "knowledge base", "llm wiki", "karpathy wiki".
---

# Add Karpathy LLM Wiki

Set up a persistent wiki knowledge base on NanoMika, based on Karpathy's LLM Wiki pattern.
