...
NanoMika doesn't ship channels in trunk. This skill copies the Matrix adapter in from the `channels` branch.
...
MATRIX_DEVICE_ID=NANOMIKA01                    # Stable device ID across restarts
```
